...
{
    IMAConversation *conversation = (IMAConversation *)_showItem;
    _conversationName.text = conversation.nickName;
    [_conversationIcon sd_setBackgroundImageWithURL:[NSURL URLWithString:conversation.headUrl]  forState:UIControlStateNormal placeholderImage:[_showItem defaultShowImage]];
...
//#else
    NSString *draft = [[_showItem attributedDraft] string];
