...
- (UIButton *)createOriPicRadioBtn
{
    ...
    UIButton *oriPicRadioBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    [layer setBorderColor:[[UIColor grayColor] CGColor]];
     [oriPicRadioBtn setImage:[UIImage imageNamed:@"unselect"] forState:UIControlStateSelected];
    [oriPicRadioBtn setImage:[UIImage imageNamed:@"select"] forState:UIControlStateSelected];
...
//    [sendBtn setBackgroundColor:[UIColor flatWhiteColor]];
    ...
    [sendBtn setTitleColor:COLOR_BLACK forState:UIControlStateNormal];
