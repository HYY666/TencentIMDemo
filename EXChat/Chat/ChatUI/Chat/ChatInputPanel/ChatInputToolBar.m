...
- (void)addOwnViews
{
    ...
    [_audioPressed setTitleColor:Color_666 forState:UIControlStateNormal];
    [_audioPressed setTitleColor:COLOR_WHITE forState:UIControlStateHighlighted];
...
{
    if (_isChatRoom) {
        [HYYHudView showMsg:@"大厅禁用此功能" inView:nil];
        return;
    }
