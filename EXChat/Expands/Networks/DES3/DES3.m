...
+ (NSString *)encryptWithText:(NSString *)plantText key:(NSString *)key
{
    //kCCEncrypt 加密
    return [self encrypt:plantText encryptOrDecrypt:kCCEncrypt key:key];
}

+ (NSString *)decryptWithText:(NSString *)encryText key:(NSString *)key
{
    //kCCDecrypt 解密
    return [self encrypt:encryText encryptOrDecrypt:kCCDecrypt key:key];
}
...
//        Byte *testByte = (Byte *)[encryptData bytes];
