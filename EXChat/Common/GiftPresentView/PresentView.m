...
- (void)setModel:(GiftModel *)model {
    ...
    [_headImageView sd_setImageWithURL:[NSURL URLWithString:model.headImage] placeholderImage:[UIImage imageNamed:DEFAULT_AVATAR]];
   
    [_giftImageView sd_setImageWithURL:[NSURL URLWithString:model.giftImage] placeholderImage:nil];
